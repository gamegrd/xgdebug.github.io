...
```yml
# Site settings
title: xgDebug Blog             # title of your website
SEOTitle: xgDebug Blog          # check out docs for more detail
...
For instance, [Hello 2015])(https://xgDebug.me/2015/01/29/hello-2015/) has the front-matter of this:
...
1. a _text style_ header like [this](https://xgDebug.me/2019/09/08/spacemacs-workflow/) with
...
![](http://xgDebug.me/img/blog-sidebar.jpg)
...
![](http://xgDebug.me/img/blog-keynote.jpg)
...
---
layout:     keynote
iframe:     "http://xgDebug.me/js-module-7day/"
---
```
...
It's possible that you want the two things different. For me, my site-title is **“xgDebug Blog”** but I want the title shows in search engine is **“黄玄的博客 | xgDebug Blog”** which is multi-language.
...
- Brand new [Archive](https://xgDebug.me/archive/) page! It combines previous Archive and Tag page and it's backward-cmpatible.
...
<img src="http://xgDebug.me/img/blog-md-navbar.gif" width="320" />
