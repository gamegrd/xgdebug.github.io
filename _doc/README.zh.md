...
**[在这里预览模板 &rarr;](http://xgDebug.me/huxblog-boilerplate/)**
...
```
# Site settings
title: xgDebug Blog             # 你的博客网站标题
SEOTitle: xgDebug Blog			# 在后面会详细谈到
...
ga_domain: xgDebug.me			# 默认的是 auto, 这里我是自定义了的域名，你如果没有自己的域名，需要改成auto。
```
...
我的博客标题是 **“xgDebug Blog”** 但是我想要在搜索的时候显示 **“黄玄的博客 | xgDebug Blog”** ，这个就需要SEO Title来定义了。
